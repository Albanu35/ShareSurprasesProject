...
public class Candies implements ISurprise {
	...
	Candies(int nrOfCandies, String typeOfCandies) {
	...
	@Override
	public void enjoy() {
		System.out.println("Yeee! I have received " + this.nrOfCandies + " " + this.typeOfCandies + " candies!");
	}
	...
	public String toString() {
		return "I have received " + this.nrOfCandies + " candies of type: " + this.typeOfCandies;
	}
